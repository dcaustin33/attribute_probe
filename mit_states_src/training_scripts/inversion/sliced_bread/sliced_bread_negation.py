...
imagenet_templates_small = [
    "a photo of {} bread that is not whole",
    "a rendering of {} bread",
    "a cropped photo of {} bread that is not in its original form",
    "the photo of {} bread",
    "a photo of clean {} bread that is not whole",
    "a photo of dirty {} bread",
    "a dark photo of {} bread that is not whole",
    "a photo of {} bread",
    "a close-up photo of {} bread",
    "a bright photo of {} bread that is not whole",
    "a good photo of {} bread",
    "a photo of one {} bread that is not whole",
    "a close-up photo of {} bread",
    "a rendition of {} bread that is not whole",
    "a photo of nice {} bread",
    "a good photo of {} bread that is not whole",
    "a photo of weird {} bread",
    "a photo of large {} bread that is not whole",
    "a photo of cool {} bread",
    "a photo of small {} bread that is not whole",
]
...
hyperparameters = {
    ...
    "seed": 42,
    "output_dir": "sliced-bread-negation-concept"
}
...
grid.save("negation_output/cucumber.png")
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/baseball.png")
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/tomato.png")

prompt = "a photo of an {} apple".format(placeholder_token)  #@param {type:"string"}
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/apple.png")
