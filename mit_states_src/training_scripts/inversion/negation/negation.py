...
imagenet_templates_small = [
    "a photo of a ball shape with the color {}",
    "a rendering of a ball shape with the color {} and is not green",
    "a cropped photo of a ball shape with the color {}",
    "the photo of a ball shape with the color {} and is not the color yellow",
    "a photo of a clean ball shape with the color {}",
    "a photo of a dirty ball shape with the color {} and is not the color purple",
    "a dark photo of a ball shape with the color {}",
    "a photo of a ball shape that is not white and instead is the color {}",
    "a close-up photo of a ball shape with the color {}",
    "a bright photo of a ball shape with the color {} and is not the color black",
    "a good photo of a ball shape with the color {}",
    "a photo of one ball shape that is not orange and instead is the color {}",
    "a close-up photo of a ball shape with the color {}",
    "a rendition of a ball shape with the color {} and is not the color blue",
    "a photo of a nice ball shape with the color {}",
    "a good photo of a ball shape with the color {} and is not the color gray",
    "a photo of a weird ball shape with the color {}",
    "a photo of a large ball shape with the color {} and is not the color tan",
    "a photo of a cool ball shape with the color {}",
    "a photo of a small ball shape with the color {} and is not the color brown",
]
...
prompt = "a photo of a ball shape with the color {}".format(placeholder_token1) #@param {type:"string"}
