...
from mit_states_with_attribute import MIT_states
...
def training_step(data: dict, 
    ...
    classification_out, clip_image_logits = model(data['adjective_sentence'], images)
...
if __name__ == '__main__':
    ...
    model = CLIP_text_image_with_attribute(adjectives = adjectives, nouns = nouns, concat = concat, args=None)
