...
def prepare_data(dataset_args, val_dataset_args):
    ...
    #create the dataset
    train_dataset = MIT_states(dataset_args['root'], dataset_args, download=download, transformation=dataset_args['transformation'])
    ...
    val_dataset = MIT_states(dataset_args['root'], val_dataset_args, download=download, train = False, transformation=val_dataset_args['transformation'])
...
def training_step(data: dict, 
    ...
    if not args.dataset_args['transformation']:
