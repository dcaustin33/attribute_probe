...
custom_templates = {'soccer':
        [
            "A photo of a {} object on green grass that is not red",
            "A photo of a nice {} object on green grass that is not yellow",
            "a bright photo of a {} shape",
            "a close-up photo of a {} object with the color white and black",
            "a good photo of a {} object that is not blue",
            "A photo of a {} object with a checkered pattern that is not red",
            "a rendering of a {} shape",
            
        ],
    'baseball':
    [
        "A photo of a {} object on green grass that is not black",
        "A photo of a nice {} object on green grass that is not purple",
        "a bright photo of a {} shape that is not yellow",
        "a close-up photo of a {} object with the color white",
        "a good photo of a {} object",
         "a rendering of a {} shape",
    ],
    'adult_kickball':
    [
        "A photo of a person with a {} object on green grass",
        "A photo of a nice person with a {} object on green grass",
        "a bright photo of a person with a {} shape",
        "a close-up photo of a person with a {} object with the color {} that is not green",
        "a good photo of a person with a {} object that has the color {} that is not blue",
         "a rendering of a person with a {} shape with the color {}",
    ],
    'kickball':
    [
        "A photo of a {} object on green grass that is not blue",
        "A photo of a nice {} object on green grass",
        "a bright photo of a {} shape",
        "a close-up photo of a {} object with the color {} that is not purple",
...
hyperparameters = {
    ...
    "seed": 42,
    "output_dir": "negation-decomposed-ball-concept"
}
...
grid.save("negation_output/ball0.png")
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/ball1.png")
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/ball2.png")
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/ball3.png")
...
grid = image_grid(all_images, num_samples, num_rows)
grid.save("negation_output/ball4.png")
