...
prompt = "a photo of a {} shape".format(placeholder_token1, placeholder_token2) #@param {type:"string"}
...
prompt = "a photo of a bird with the color {}".format(placeholder_token1, placeholder_token2) #@param {type:"string"}
