...
grid.save('basketball_pics_grid.png')
...
custom_templates = {
    "yellow": ["a photo of a {}",
                ...
                "a bright photo of a {}",
                "a good photo of a {}",
                "a photo of a {} with the color {}",
                "a rendering of a {} with the color {}",
                "a cropped photo of a {} with the color {}",
                "the photo of a {} with the color {}",
                "a photo of a clean {} with the color {}",
                "a photo of a dirty {} with the color {}",
                "a dark photo of a {} with the color {}",
                "a photo of a {} with the color {}",
                "a close-up photo of a {} with the color {}",
                "a bright photo of a {} with the color {}",
                "a good photo of a {} with the color {}",
    ],
    'regular': ["a photo of a {}",
                "a rendering of a {}",
                "a cropped photo of a {}",
                "the photo of a {}",
                "a photo of clean a {}",
...
class TextualInversionDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        path = image_path.split('.')[0].split('_')[0]

        if path == 'yellow':
            templates = custom_templates['yellow']
        else:
            templates = custom_templates['regular']
