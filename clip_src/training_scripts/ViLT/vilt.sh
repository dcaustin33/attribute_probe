...
#                           --batch_size 256 \
#                           --name Eval_CUB_ViLT_with_1_attributes \
#                           --dist_url env:// \
#                           --workers 8 \
...
#torchrun --nproc_per_node 1 eval_with_attribute.py \
#                           --batch_size 256 \
#                           --name Eval_CUB_ViLT_with_2_attributes \
#                           --dist_url env:// \
#                           --workers 8 \
#                           --certainty_threshold 2 \
#                           --attribute_idx_amount 2 \
#                           --saved_path checkpoints/CUB_ViLT_with_2_attributes/CUB_ViLT_with_2_attributes_Final.pt \
#                           -log;
#
torchrun --nproc_per_node 1 eval_with_attribute.py \
                           --batch_size 256 \
                           --name Eval_CUB_ViLT_with_3_attributes \
                           --dist_url env:// \
                           --workers 8 \
                           --certainty_threshold 2 \
                           --attribute_idx_amount 3 \
...
#torchrun --nproc_per_node 1 eval_with_attribute.py \
#                           --batch_size 256 \
#                           --name Eval_CUB_ViLT_with_0_attributes \
#                           --dist_url env:// \
#                           --workers 8 \
#                           --certainty_threshold 2 \
