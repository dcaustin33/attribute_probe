...
def training_step(data: dict, 
    ...
    accuracys = []
    loss = 0
    loss += cross_entropy_loss(classification_out, attributes, truth)
    accuracys.append(return_accuracy(classification_out, attributes, truth)[0])
    _, maj_accuracy = return_accuracy(classification_out, attributes, truth)
